    ...
    <div className="">
      ...
      >
        <div className="w-[360px] text-center p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-xl bg-white">
          ...
          <p className="text-left my-3 pl-5">Fancy something unusual and unpredictable? Funny or sexy? No problem. Use our unique mood and emotion search to find great books with exactly the flavour you've asked for.</p>
